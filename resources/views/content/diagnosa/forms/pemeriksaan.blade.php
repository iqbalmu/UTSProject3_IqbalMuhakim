    ...
    <div class="card-body">
        <div class="row">
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('suhu') is-invalid @enderror" value="{{ old('suhu') }}" type="text"
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('tekanan_darah') is-invalid @enderror" value="{{ old('tekanan_darah') }}"
                    type="text" id="tekanan_darah" name="tekanan_darah" placeholder="" />
                @error('tekanan_darah')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('nadi') is-invalid @enderror" value="{{ old('nadi') }}"
                    type="text" id="nadi" name="nadi" placeholder="" />
                @error('nadi')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('pernapasan') is-invalid @enderror" value="{{ old('pernapasan') }}"
                    type="text" id="pernapasan" name="pernapasan" placeholder="" />
                @error('pernapasan')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('tinggi') is-invalid @enderror" value="{{ old('tinggi') }}"
                    type="text" id="tinggi" name="tinggi" placeholder="" />
                @error('tinggi')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('berat') is-invalid @enderror" value="{{ old('berat') }}"
                    type="text" id="berat" name="berat" placeholder="" />
                @error('berat')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('labor') is-invalid @enderror" value="{{ old('labor') }}"
                    type="text" id="labor" name="labor" placeholder="" />
                @error('labor')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('rontgen') is-invalid @enderror" value="{{ old('rontgen') }}"
                    type="text" id="rontgen" name="rontgen" placeholder="" />
                @error('rontgen')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('usg') is-invalid @enderror" value="{{ old('usg') }}"
                    type="text" id="usg" name="usg" placeholder="" />
                @error('usg')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('ctscan') is-invalid @enderror" value="{{ old('ctscan') }}"
                    type="text" id="ctscan" name="ctscan" placeholder="" />
                @error('ctscan')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input class="form-control @error('mri') is-invalid @enderror" value="{{ old('mri') }}"
                    type="text" id="mri" name="mri" placeholder="" />
                @error('mri')
                    <div class="form-text text-danger">
                        {{ $message }}
                    </div>
