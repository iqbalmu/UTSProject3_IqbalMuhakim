...
@section('header', 'Update Data Admisi')
...
@section('content')
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2 d-flex">
                        <div>
                            <a href="{{ route('admisi.edit', $user->id_user) }}" class="btn btn-primary me-2">Edit</a>
                        ...
                        <button type="button" class="btn btn-outline-danger ms-auto" data-bs-toggle="modal"
                            data-bs-target="#modalDeleteAdmisi">
                            Delete
                        </button>
                    </div>
                </div>
    ...
    @include('content.admisi.modal.delete')
@endsection
